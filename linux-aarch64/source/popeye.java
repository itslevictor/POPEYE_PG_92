...
public class popeye extends PApplet {
  ...
  if (tela == 1) {
    ...
    if (posB>=1&&posB<=4) {
      ...
      if (posB<=0&&tempB==120) {
        ...
        ataqueB = 0;
        tempB=0;
        pontos+=PApplet.parseInt(pBonus);
        pBonus=0;
      }
...
public void draw() {
  ...
  public void settings() { size(748, 396); }

  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "popeye" };
    if (passedArgs != null) {
